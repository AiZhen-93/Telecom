...
if (projectVideosPage) {
    ...
    const createCard = (item, index) => {
        ...
        image.src = item.thumbnail || "pic/YT_icon.png";
...
if (mergeZonePage) {
    ...
    const createTower = (tower) => {
        ...
        const image = document.createElement("img");
        image.src = tower.image || "pic/profile.png";
    ...
    const createVideos = (videos) => {
        ...
        items.forEach((video) => {
            ...
            image.src = youtubeId ? `pic/merge-video-${youtubeId}.jpg` : "pic/YT_icon.png";
...
if (nightSleepPage) {
    ...
    const makeTower = (operator) => {
        ...
        tower.src = `pic/CellTower_${operator.key.toUpperCase()}.svg`;
